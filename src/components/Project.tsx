    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://github.com/biaros0505/MedicalAppointmentApp" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
                <a href="https://github.com/biaros0505/MedicalAppointmentApp" target="_blank" rel="noreferrer"><h2>Medical Appointment App</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros0505/StreamingVSCable" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
                <a href="https://github.com/biaros0505/StreamingVSCable" target="_blank" rel="noreferrer"><h2>Streaming VS Cable Services</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros0505/UNOgame" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
                <a href="https://github.com/biaros0505/UNOgame" target="_blank" rel="noreferrer"><h2>Uno Console Card Game</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros0505/RecipeApp" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
                <a href="https://github.com/biaros0505/RecipeApp" target="_blank" rel="noreferrer"><h2>Recipe App</h2></a>
