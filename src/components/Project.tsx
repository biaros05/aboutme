    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://github.com/biaros05/MedicalAppointmentApp" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros05/StreamingVSCable" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros05/UNOgame" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros05/RecipeApp" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt="" width="100%"/></a>
