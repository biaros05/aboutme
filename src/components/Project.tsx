    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://github.com/biaros05/MedicalAppointmentApp" target="_blank" rel="noreferrer"><img src={medical} className="zoom" alt="" height="250vh" /></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros05/StreamingVSCable" target="_blank" rel="noreferrer"><img src={""} className="zoom" alt=""height="250vh"/></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros05/UNOgame" target="_blank" rel="noreferrer"><img src={UNO} className="zoom" alt="" height="250vh"/></a>
            ...
            <div className="project">
                <a href="https://github.com/biaros05/RecipeApp" target="_blank" rel="noreferrer"><img src={recipes} className="zoom" alt="" height="250vh"/></a>
