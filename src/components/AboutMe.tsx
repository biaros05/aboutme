  ...
  return (
    <div className="container">
      ...
      <p>Hey there! My name is Bianca Rossetti and I'm a <b>Computer Science student</b> at Dawson College. 
        ...
        Some day, i hope <b>my work can have an impact</b> on at least one person for the better, because that would mean, 
        to me, that I am <b>fulfulling my duty as a Computer Scientist</b> to make people's lives easier through automation 
        and programmation! And someday, I hope my work manages to travel to space and back :)</p>
    </div>
  );
}
